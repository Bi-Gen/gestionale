...
export default async function FattureAcquistoPage() {
  const result = await getFatture({ tipo: 'acquisto' })
    ...
    <div className="space-y-6">
      ...
      <div className="md:flex md:items-center md:justify-between">
        <div className="min-w-0 flex-1">
          <h1 className="text-2xl font-bold text-gray-900">Fatture Acquisto</h1>
          <p className="mt-1 text-sm text-gray-500">
            Gestisci le fatture ricevute dai fornitori
          </p>
        </div>
        <div className="mt-4 flex md:ml-4 md:mt-0">
          <Link
            href="/dashboard/fatture/acquisto/nuovo"
              ...
              {fatture.length === 0 ? (
                <tr>
                  <td colSpan={9} className="px-6 py-12 text-center text-sm text-gray-500">
                    ...
                    <p className="mt-1 text-gray-400">Inizia registrando la tua prima fattura di acquisto</p>
                    <Link
                      href="/dashboard/fatture/acquisto/nuovo"
