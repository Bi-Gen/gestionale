...
export default async function ClientiPage({
  ...
  const soggetti = await getSoggettiByTipoCodice('CLI')
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-6 flex justify-between items-center">
        ...
        <Link
          href={`/dashboard/soggetti/nuovo?tipo=CLI&return=/dashboard/clienti`}
                  ...
                  <tr key={soggetto.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-xs text-gray-500">
                        {soggetto.partita_iva || soggetto.codice_fiscale || ''}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      {soggetto.categoria_cliente ? (
                        <span
                          ...
                          style={{
                            backgroundColor: soggetto.categoria_cliente.colore ? `${soggetto.categoria_cliente.colore}20` : '#e5e7eb',
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      {soggetto.agente ? (
                        <div className="text-sm text-gray-900">
                          {soggetto.agente.codice_agente && (
                            <span className="text-gray-500">[{soggetto.agente.codice_agente}] </span>
                          )}
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex justify-end items-center gap-3">
                        ...
                        <Link
                          href={`/dashboard/soggetti/${soggetto.id}/modifica?tipo=CLI&return=/dashboard/clienti`}
